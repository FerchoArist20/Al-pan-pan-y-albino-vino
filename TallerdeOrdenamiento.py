...
numberList = [350,600000,1,20,30000,400,50000,2,375,1000000]

print(zero_completion(numberList))
print("-------------------")
radixSort(zero_completion(numberList))

"""##Burbuja"""

datos = [30, 69, 96, -12, -115, 1, 3, 4]
